...
page_init(void)
{
	...
	//1
        ...
        void* bootMem = boot_alloc(0);
        
        for (i = PGNUM(EXTPHYSMEM); i < PGNUM(PADDR(bootMem)); i++)
        {
                //4.1
                pages[i].pp_ref = 1;
        ...
        for (i = PGNUM(PADDR(bootMem)); i < npages; i++)
        {
                //4.2
                pages[i].pp_ref = 0;
                pages[i].pp_link = page_free_list;
...
pgdir_walk(pde_t *pgdir, const void *va, int create)
{
        ...
        } else
        {
                ...
                pageInfo->pp_ref++;
                *pde = page2pa(pageInfo) | PTE_U | PTE_W | PTE_P;
                pte = page2kva(pageInfo);
        }
